                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="status_siswa" class="form-select @error('status_siswa') is-invalid @enderror" required>
                                    <option value="Baru" {{ old('status_siswa') == 'Baru' ? 'selected' : '' }}>Baru</option>
                                    <option value="Lama" {{ old('status_siswa') == 'Lama' ? 'selected' : '' }}>Lama</option>
                                </select>
                                @error('status_siswa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="status_iqra" class="form-select @error('status_iqra') is-invalid @enderror" required>
                                    <option value="Alumni TK" {{ old('status_iqra') == 'Alumni TK' ? 'selected' : '' }}>Alumni TK</option>
                                    <option value="Bukan Alumni" {{ old('status_iqra') == 'Bukan Alumni' ? 'selected' : '' }}>Bukan Alumni</option>
                                </select>
                                @error('status_iqra')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
